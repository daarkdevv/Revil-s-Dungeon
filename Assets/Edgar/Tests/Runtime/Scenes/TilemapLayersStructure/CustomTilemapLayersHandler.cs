...
namespace Edgar.Unity.Edgar.Tests.Runtime.Scenes.TilemapLayersStructure
{
    ...
    public class CustomTilemapLayersHandler : TilemapLayersHandlerBaseGrid2D
    {
        ...
        public override void InitializeTilemaps(GameObject gameObject)
        {
            ...
            wallsTilemapObject.GetComponent<TilemapRenderer>().sortingOrder = 2;
            wallsTilemapObject.layer = 6;
            ...
            floorTilemapObject.GetComponent<TilemapRenderer>().sortingOrder = 1;
            ...
            other1TilemapObject.layer = default;

            other1TilemapObject.GetComponent<TilemapRenderer>().sortingOrder = 1;
